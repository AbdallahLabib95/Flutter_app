...
import 'package:flutter_app/car_rental/pages/page9.1.dart';
import 'package:flutter_app/car_rental/pages/page9.10.dart';
import 'package:flutter_app/car_rental/pages/page9.13.dart';
import 'package:flutter_app/car_rental/pages/page9.3.dart';
import 'package:flutter_app/car_rental/pages/page9.4.dart';
import 'package:flutter_app/car_rental/pages/page9.5.dart';
import 'package:flutter_app/car_rental/pages/page9.6.dart';
import 'package:flutter_app/car_rental/pages/page9.7.dart';
import 'package:flutter_app/car_rental/pages/page9.8.dart';
import 'package:flutter_app/car_rental/pages/page9.dart';
import 'package:flutter_app/car_rental/pages/page912.dart';
import 'package:flutter_app/car_rental/widgets/review_rateing.dart';
import 'package:flutter_app/car_rental/widgets/session_card.dart';

class CarRentalHomePage extends StatefulWidget {
  CarRentalHomePage({Key key, this.title}) : super(key: key);
